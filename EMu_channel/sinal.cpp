...
xi_sist_2->Fit("xi_sist_inter_2");
 ...
 TFile fundo ("/eos/user/m/mpisano/analyzer_emu/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/EMu_2018_UL_july.root");
 TTree* ntp1 = (TTree*) fundo.Get("ntp1");
 TFile output ("./EMu_sinal_SM_july.root", "RECREATE", "");
...
for (int i = 0; i < ntp1 -> GetEntries(); i++){
	...
	ntp1 -> SetBranchAddress ("bsm_weights", &bsm_weights, &bsm_weightsB);
        ...
        weight_sample = 54900.*((*bsm_weights)[51])/(4000.*1000.);
