...
xi_sist_2->Fit("xi_sist_inter_2");
 ...
 TFile fundo ("/eos/user/m/mpisano/analyzer_emu/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/Data_EMuTriggers_2018_UL_sgn_BSM_scalar_800_nov.root");
 TTree* ntp1 = (TTree*) fundo.Get("ntp1");
 TFile output ("./EMu_sinal_BSM_scalar_m800.root", "RECREATE", "");
...
for (int i = 0; i < ntp1 -> GetEntries(); i++){
	...
	//ntp1 -> SetBranchAddress ("bsm_weights", &bsm_weights, &bsm_weightsB);
        ...
        weight_sample = 54900.*1/(4000.*568.);
