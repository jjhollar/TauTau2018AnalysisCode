...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   reader->AddVariable( "sist_mass - sqrt(13000.0*13000.0*xi_arm1_1*xi_arm2_1)", &var6 );
   reader->AddVariable( "mu_pt", &var7);
   reader->AddVariable( "e_pt", &var8);
   reader->AddVariable( "sist_rap-0.5*log(xi_arm1_1/xi_arm2_1)",                &var9 );
   ...
   TFile *input(0);
   // JH
   //   TString fname = "/eos/user/m/mpisano/samples_2018_emu/fase1/Dados_fase1_PICskimmed_EMu_2018_total-proton.root";
   TString fname = "EMu_sinal_SM_july.root";
   //   TString fname = "/eos/user/m/mpisano/samples_2018_emu/fase1/DY_fase1_PICskimmed_EMu_2018_total-proton.root";
   //   TString fname = "/eos/user/m/mpisano/samples_2018_emu/fase1/ttjets_fase1_PICskimmed_EMu_2018_total-proton.root";
   // end JH
   ...
   theTree->SetBranchAddress( "weight_sm", &userVar8 );
   theTree->SetBranchAddress( "mu_pt", &userVar9 );
   theTree->SetBranchAddress( "e_pt", &userVar10 );
