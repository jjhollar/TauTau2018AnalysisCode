...
int main(){
  ...
  //string prefix = "root:://cms-xrd-global.cern.ch//";
	...
	string prefix_output = "ttjets_fase1_PIC_skimmed_EMu_2018_";
	...
	ifstream ifile;
	ifile.open("ttjets_fase1_emu.txt");
	...
	for(int i=0; i<tree->GetEntries(); i++){
		...
		double k_e = 1;
                //double tau_id_sf
                //tau_id_sf=f_id_sf->Eval(tree->GetLeaf("tau0_pt")->GetValue(0))*f_id_sf->Eval(tree->GetLeaf("tau1_pt")->GetValue(0));
