...
int main() {
   ...
   histDY->Scale(72.5/histDY->Integral()); // pesos
    histQCD->Scale(24.1/histQCD->Integral());
    histTTJets->Scale(6.98/histTTJets->Integral());
    histSinal->Scale(8.89e-2*5000/histSinal->Integral());
