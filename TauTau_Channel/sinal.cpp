...
TLorentzVector tau0, tau1, nu;
 ...
 TFile fundo ("/eos/user/m/mpisano/analyser/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/Signal_TauTau18_SM_july.root");

TTree* ntp1 = (TTree*) fundo.Get("ntp1");

TFile output ("./TauTau_sinal_PIC_july_2018.root", "RECREATE", "");
