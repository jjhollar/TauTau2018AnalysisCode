...

{
   ...
   TString fnameBKG = "/eos/user/m/mpisano/samples_2018_tautau/fase1/soma/Fundo_total-protons_2018_tautau_syst.root";

   //TString fnameSIGN = "./TauTau_sinal_PIC_march_2018_xi1_dw_syst.root";

   TString fnameSIGN = "./TauTau_sinal_PIC_july_2018.root";
...
//  #################################################################################################################################
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                           ...
                                           "nTrain_Signal=2500:nTrain_Background=600:SplitMode=Random:NormMode=NumEvents:!V" );
