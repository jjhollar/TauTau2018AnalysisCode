...
// samples for DY  region
          TFile data("/eos/user/m/mpisano/samples_2018_tautau/fase1/soma/Dados_fase1-protons_2018_tautau.root");;
          TFile dy("/eos/user/m/mpisano/samples_2018_tautau/fase1/soma/DY_total-protons_2018_tautau.root");
          TFile ttjets("/eos/user/m/mpisano/samples_2018_tautau/fase1/soma/ttjets_total-protons_2018_tautau.root");
          TFile qcd("/eos/user/m/mpisano/samples_2018_tautau/fase1/soma/QCD_total-protons_2018_tautau.root");
	...
	double n_data=0;
		...
		r_data.Fill(tree_data->GetLeaf("sist_rap")->GetValue(0)-0.5*log(tree_data->GetLeaf("xi_arm1_1")->GetValue(0)/tree_data->GetLeaf("xi_arm2_1")->GetValue(0)),w_data);
                ...
                tau_data.Fill(tree_data->GetLeaf("tau0_pt")->GetValue(0),w_data);
	...
	m_qcd.SetLineWidth(0);
		...
		tau_dy.Fill(tree_dy->GetLeaf("tau0_pt")->GetValue(0),w_dy);
	...
	m_dy.SetLineWidth(0);
		...
		tau_ttjets.Fill(tree_ttjets->GetLeaf("tau0_pt")->GetValue(0),w_ttjets);
	...
	for(int i=0; i<n_evt_sinal; i++){
		...
		tau_sinal.Fill(tree_sinal->GetLeaf("tau0_pt")->GetValue(0),w_sinal);
	...
	l_aco->AddEntry(&aco_sinal, "Signal (x500)", "l");
